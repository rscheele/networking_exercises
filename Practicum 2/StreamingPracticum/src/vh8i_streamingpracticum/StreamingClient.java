...
public class StreamingClient {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        String ServerHost = "192.168.178.16";
        ...
        //------------------
        theStreamingClient.RTSPsocket = new Socket(ServerIPAddr, RTSP_server_port);

        //Set input and output stream filters:
        RTSPBufferedReader = new BufferedReader(new InputStreamReader(theStreamingClient.RTSPsocket.getInputStream()));
        RTSPBufferedWriter = new BufferedWriter(new OutputStreamWriter(theStreamingClient.RTSPsocket.getOutputStream()));
